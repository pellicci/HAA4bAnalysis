...
norm_filename = "rootfiles/" + subprocess + "Normalizations_table.txt"
dir_back_input = "rootfiles/" + subprocess + "backgrounds/"

dir_sig_input = "rootfiles/" + subprocess + "signals/"
...
list_histos = ["h_jet1pt", "h_jet2pt", "h_jet3pt", "h_jet4pt", "h_jet1Btag", "h_jet2Btag", "h_jet3Btag", "h_jet4Btag", "h_delta_Phi_pair", "h_delta_Eta_pair", "h_Events"]
...
h_signal[list_histos[4]]  = ROOT.TH1F(list_histos[4] + "_Signal", "Btag value  of 1st jet", 50, 0.89, 1.)
h_signal[list_histos[5]]  = ROOT.TH1F(list_histos[5] + "_Signal", "Btag value  of 2nd jet", 50, 0.89, 1.)
h_signal[list_histos[6]]  = ROOT.TH1F(list_histos[6] + "_Signal", "Btag value  of 3rd jet", 50, 0.89, 1.)
h_signal[list_histos[7]]  = ROOT.TH1F(list_histos[7] + "_Signal", "Btag value  of 4th jet", 50, 0.89, 1.)
...
h_signal[list_histos[10]] = ROOT.TH1F(list_histos[10] + "_Signal", "Events after pre-selection steps", 6, 0., 6.)
